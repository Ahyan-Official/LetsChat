...
////            Picasso.with(holder.profileImage.getContext()).load(mes.getMessage()).resize(500,500).placeholder(R.drawable.user_img).into(holder.messageImage);
//
//        }
        ...
        if(from_user_id.equals(current_user_id)){
            ...
            //holder.messageText.setBackgroundResource(R.drawable.chat_round3);
...
//            RelativeLayout.LayoutParams params1 = (RelativeLayout.LayoutParams)holder.messageImage.getLayoutParams();
//            params1.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
//            holder.messageImage.setLayoutParams(params1);

            //holder.messageText.setTextColor(Color.BLACK);
        }
        else{

           // holder.messageText.setBackgroundResource(R.drawable.chat__44);
//            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)holder.messageText.getLayoutParams();
